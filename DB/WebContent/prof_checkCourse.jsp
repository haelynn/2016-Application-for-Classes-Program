...
<div class="content">
<center>
<form action="searchCourse.jsp" method="post" target="pcourseif">
	...
	<input type="submit" value="검색" name="pcourseif" style="height: 45px; width: 100px; background-color: #00a6de; color: #fff;">
</form>	

	<p>
	<iframe src="showCourse.jsp" name="pcourseif" width="1200px" height="500px" style="background-color: #fff;"></iframe>
	<p>
	
	수업 정보 변경을 원하시면 관리자(VOS팀)에 문의주세요
